...
Public Language As Long         'english; Italian; = 0; 1; etc

'Load English phrases
Private Sub sPhraseEng(Index As Long, Eng As String)
    If Language <> 0 Then Exit Sub
    Phrase(Index) = Eng
End Sub

'Load Italian phrases
Private Sub sPhraseIta(Index As Long, Ita As String)
    If Language <> 1 Then Exit Sub
    Phrase(Index) = Ita 'Replace(Ita, "**", "")
End Sub

'Load French phrases
Private Sub sPhraseFra(Index As Long, Fra As String)
    If Language <> 2 Then Exit Sub
    Phrase(Index) = Fra
End Sub

'Load German phrases
Private Sub sPhraseGer(Index As Long, Ger As String)
    If Language <> 3 Then Exit Sub
    Phrase(Index) = Ger
End Sub

'Load Spanish phrases
Private Sub sPhraseSpa(Index As Long, Spa As String)
    If Language <> 4 Then Exit Sub
    If gCheatMode.testing Then
        Phrase(Index) = "<" & CStr(Index) & ">"
    Else
        Phrase(Index) = Spa
    End If
End Sub

'Load Swedish phrases
Private Sub sPhraseSwe(Index As Long, Swe As String)
    If Language <> 5 Then Exit Sub
    Phrase(Index) = Swe
End Sub

'Load Norwegian phrases
Private Sub sPhraseNor(Index As Long, Nor As String)
    If Language <> 6 Then Exit Sub
    Phrase(Index) = Nor
End Sub

'Load Norwegian phrases
Private Sub sPhraseDan(Index As Long, Nor As String)
    If Language <> 7 Then Exit Sub
    Phrase(Index) = Nor
End Sub
...
Public Function SubstituteStringTokens(ByRef pString As String) As String
    ...
    pString = Replace(pString, "<Var.HomePage>", gcHomeWebPage)
    pString = Replace(pString, "<Var.Maj>", Trim(str(App.Major)))
    pString = Replace(pString, "<Var.Min>", Trim(str(App.Minor)))
    pString = Replace(pString, "<Var.Rev>", Trim(str(App.Revision)))
...
'Load phrases into string array.
...
Private Sub InitialisePhrases()
    ...
    'REM:
    sPhraseEng 21, "Limit supply lines"
    ...
    'REM:
    sPhraseEng 53, "<Var.ExeName> &registration"
    sPhraseIta 53, "<Var.ExeName>: &registrazione"
    sPhraseFra 53, "Inscription <Var.ExeName>"
    sPhraseGer 53, "<Var.ExeName> &Registrierung"
    sPhraseSpa 53, "&inscripción en <Var.ExeName>"
    sPhraseSwe 53, "Registrera <Var.ExeName>"
    sPhraseNor 53, "<Var.ExeName> registrering"
    sPhraseDan 53, "<Var.ExeName> registrering"

    'REM:
    sPhraseEng 54, "Register <Var.ExeName> &online..."
    sPhraseIta 54, "Registra <Var.ExeName> &online..."
    sPhraseFra 54, "Enregistrez <Var.ExeName> en ligne..."
    sPhraseGer 54, "<Var.ExeName> &online registrieren"
    sPhraseSpa 54, "inscripción en <Var.ExeName> &en línea..."
    sPhraseSwe 54, "Registrera <Var.ExeName> online..."
    sPhraseNor 54, "Registrer <Var.ExeName> via Internett..."
    sPhraseDan 54, "Registrer <Var.ExeName> online..."

    'REM:
    sPhraseEng 55, "&Enter registration code..."
    sPhraseIta 55, "Inserisci il &codice di registrazione..."
    sPhraseFra 55, "Entrez le code d'enregistrement..."
    sPhraseGer 55, "&Registrierungscode eingeben"
    sPhraseSpa 55, "&Ingrese código de registro..."
    sPhraseSwe 55, "Ange registreringskod..."
    sPhraseNor 55, "Skriv inn registreringskode..."
    sPhraseDan 55, "Indtast registreringskode..."
    ...
    sPhraseEng 68, "<Var.Mission14> countries."
    sPhraseIta 68, "<Var.Mission14> territori."
    sPhraseFra 68, "<Var.Mission14> pays."
    sPhraseGer 68, "<Var.Mission14> Länder."
    sPhraseSpa 68, "<Var.Mission14> países."
    sPhraseSwe 68, "<Var.Mission14> länder."
    sPhraseNor 68, "<Var.Mission14> land."
    sPhraseDan 68, "<Var.Mission14> lande."
    ...
    'REM:
    sPhraseEng 85, "Warning"
    sPhraseIta 85, "Attenzione"
    sPhraseFra 85, "Attention"
    sPhraseGer 85, "Warnung"
    sPhraseSpa 85, "Cuidado"
    sPhraseSwe 85, "Varning"
    sPhraseNor 85, "Advarsel"
    sPhraseDan 85, "Advarsel"
    ...
    'REM:
    sPhraseEng 87, "Welcome to <Var.ExeName> v."
    sPhraseIta 87, "Benvenuti a <Var.ExeName> v."
    sPhraseFra 87, "Bienvenue à <Var.ExeName> version ."
    sPhraseGer 87, "Willkommen zu <Var.ExeName> ."
    sPhraseSpa 87, "Bienvenido a <Var.ExeName> v."
    sPhraseSwe 87, "Välkommen till <Var.ExeName> v."
    sPhraseNor 87, "Velkommen til <Var.ExeName> v."
    sPhraseDan 87, "Velkommen til <Var.ExeName> v."
    ...
    'REM:
    sPhraseEng 94, "Notice"
    sPhraseIta 94, "Avviso"
    sPhraseFra 94, "Avis"
    sPhraseGer 94, "Nachricht"
    sPhraseSpa 94, "Aviso"
    sPhraseSwe 94, "Observera"
    sPhraseNor 94, "Beskjed"
    sPhraseDan 94, "Bemærk"
...
Private Sub initialisePhrases100()
    ...
    'REM:Title of scenario.
    sPhraseEng 148, "Title of war"
    ...
    'REM:
    sPhraseEng 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Warning: This computer program is protected by copyright law and international treaties."
    sPhraseIta 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Questo programma è protetto dalle leggi sul copyright e da trattati internazionali."
    sPhraseFra 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Attention: Ce programme informatique est protégé par les lois du copyright et les traités internationaux."
    sPhraseGer 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Warnung: Dieses Computer-Programm ist durch Urheberrechts-Gesetze und internationale Verträge geschützt."
    sPhraseSpa 185, "Derechos de autor 1998-2010 Craig Douglas." + vbCrLf _
                 + "Cuidado: Este programa de computadora está protegido por leyes de derechos de autor y acuerdos internacionales."
    sPhraseSwe 185, "Cpyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Varning: Detta program skyddas av kopieringslagar och internationella avtal."
    sPhraseNor 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Advarsel: Dette programmet er beskyttet ifølge lover om opphavsrett og internasjonale konvensjoner, herunder lov av 12. mai 1961 nr. 2 om opphavsrett til åndsverk m.v."
    sPhraseDan 185, "Copyright© 1998-2010 Craig Douglas." + vbCrLf _
                 + "Advarsel: Dette computerprogrem er beskyttet af copyright loven og internationale aftaler."
...
Private Sub initialisePhrases200()
    ...
    'REM:
    sPhraseEng 201, "&Tool box"
    sPhraseIta 201, "&Tool box"
    ...
    sPhraseEng 223, "<Var.Phrase(423)> and <Var.Phrase(424)>."
    sPhraseIta 223, "<Var.Phrase(423)> e <Var.Phrase(424)>."
    sPhraseFra 223, "<Var.Phrase(423)> et <Var.Phrase(424)>."
    sPhraseGer 223, "<Var.Phrase(423)> und <Var.Phrase(424)>."
    sPhraseSpa 223, "<Var.Phrase(423)> y <Var.Phrase(424)>."
    sPhraseSwe 223, "<Var.Phrase(423)> och <Var.Phrase(424)>"
    sPhraseNor 223, "<Var.Phrase(423)> og <Var.Phrase(424)>."
    sPhraseDan 223, "<Var.Phrase(423)> og <Var.Phrase(424)>"
    ...
    sPhraseEng 230, "Terminal "
    sPhraseIta 230, "Terminale "
    sPhraseFra 230, "Terminal "
    sPhraseGer 230, "Terminal "
    sPhraseSpa 230, "Terminal "
    sPhraseSwe 230, "Terminal "
    sPhraseNor 230, "Datamaskin "
    sPhraseDan 230, "Computer "
    ...
    sPhraseEng 257, "No, Please try again"
    sPhraseIta 257, "No, prova ancora"
    sPhraseFra 257, "Non, S'il vous plaît essayez encore."
    sPhraseGer 257, "No, bitte erneut versuchen"
    sPhraseSpa 257, "No, por favor intente de nuevo"
    sPhraseSwe 257, "Nej, var vänlig försök igen"
    sPhraseNor 257, "Nei, vennligst prøv igjen"
    sPhraseDan 257, "Nej. Prøv igen"

    'REM:
    sPhraseEng 258, "No, Make sure you enter your name and code exactly " + vbCrLf _
                 + "as you see it (capitals, spaces etc..)"
    sPhraseIta 258, "No, accertati di inserire il tuo nome ed il codice esattamente" + vbCrLf _
                 + "come lo leggi (maiuscole/minuscole, spazi, ec...)"
    sPhraseFra 258, "Non, Assurez-vous que vous entrez votre nom et code exactement" + vbCrLf _
                 + "comme vous  le voyez (majucules, espaces, etc...)"
    sPhraseGer 258, "No, stellen Sie sicher, dass Sie Name und Code exakt" + vbCrLf _
                 + "so eingeben, wie Sie es sehen."
    sPhraseSpa 258, "No, asegúrese que ingresó su nombre y código exactamente" + vbCrLf _
                 + "como lo ve (mayúsculas, espacios, etc...)"
    sPhraseSwe 258, "Nej, kontrollera att du skrivit in namn och kod exakt" + vbCrLf _
                 + "som det står (stora bokstäver, mellanslag etc...)"
    sPhraseNor 258, "Nei, vær nøye med måten du skriver inn navn og kode (store bokstaver, mellomrom etc.)"
    sPhraseDan 258, "Nej. Skriv navn og kode præcist som du ser den." + vbCrLf _
                 + "Dvs. med store bogstaver og mellemrum m.m."
...
Private Sub initialisePhrases300()
    ...
    'REM:
    sPhraseEng 341, "Register Now"
    sPhraseIta 341, "Registrati Ora"
    sPhraseFra 341, "S'Enregistrer Maintenant"
    sPhraseGer 341, "Jetzt registrieren"
    sPhraseSpa 341, "Inscribir ahora"
    sPhraseSwe 341, "Registrera Nu"
    sPhraseNor 341, "Registrer Nå"
    sPhraseDan 341, "Registrer nu"

    'REM:
    sPhraseEng 342, "Enter Code"
    sPhraseIta 342, "Inserisci il codice"
    sPhraseFra 342, "Entrez le Code"
    sPhraseGer 342, "Code eingeben"
    sPhraseSpa 342, "Ingrese código"
    sPhraseSwe 342, "Skriv in koden"
    sPhraseNor 342, "Skriv inn kode"
    sPhraseDan 342, "Indtast kode"

    'REM:
    sPhraseEng 343, "Register Later"
    sPhraseIta 343, "Registrati in seguito"
    sPhraseFra 343, "Enregistrer plus tard"
    sPhraseGer 343, "Später registrieren"
    sPhraseSpa 343, "Inscribir después"
    sPhraseSwe 343, "Registrera senare"
    sPhraseNor 343, "Registrer senere"
    sPhraseDan 343, "Registrer senere"

    'REM:
    sPhraseEng 344, "Active soon"
    sPhraseIta 344, "Presto attivo"
    sPhraseFra 344, "Bientôt actif"
    sPhraseGer 344, "Bald aktiv"
    sPhraseSpa 344, "Activar pronto"
    sPhraseSwe 344, "Snart tillgänglig"
    sPhraseNor 344, "Snart aktiv"
    sPhraseDan 344, "Snart aktiv"
    ...
    'REM:
    sPhraseEng 356, "Your mission briefing is enclosed in this document."
    sPhraseIta 356, "Il briefing del tuo Obiettivo e' contenuto in questo documento."
    sPhraseFra 356, "Le résumé de votre mission est dans ce document."
    sPhraseGer 356, "Ihre Missionsbeschreibung ist in diesem Dokument verschlossen."
    sPhraseSpa 356, "Su misión está resumida en este documento"
    sPhraseSwe 356, "Din uppdragsbeskrivning finns i detta dokument"
    sPhraseNor 356, "Ditt oppdrag befinner seg i dette dokumentet."
    sPhraseDan 356, "Din mission er inkluderet i dette dokument."
    ...
    'REM: IT:Suggerimento: Taglio e colla direttamente dalla vostra forma di registro.
    sPhraseEng 370, "Hint: Cut and paste directly from your registration form."
    sPhraseIta 370, "Suggerimento: Copia e incolla dalla maschera di registrazione"
    sPhraseFra 370, "Conseil: Copiez/Collez directement de votre formulaire d'enregistrement."
    sPhraseGer 370, "Hinweis: Schnitt und fügt direkt von Ihrer Registrierung-Form ein."
    sPhraseSpa 370, "La indirecta: Corte y pegue directamente de su formulario de la registración."
    sPhraseSwe 370, "Tips: Kopiera direkt från registreringsformuläret."
    sPhraseNor 370, "Tips: Klipp og lim tekst direkte fra ditt registreringsskjema."
    sPhraseDan 370, "Tip: Kopier og sæt ind fra din registreringsform"
    ...
    'REM:
    sPhraseEng 375, "Alberta"
    sPhraseIta 375, "Alberta"
    sPhraseFra 375, "Alberta"
    sPhraseGer 375, "Alberta"
    sPhraseSpa 375, "Alberta"
    sPhraseSwe 375, "Alberta"
    sPhraseNor 375, "Alberta"
    sPhraseDan 375, "Alberta"
    ...
    'REM:
    sPhraseEng 380, "Central America"
    sPhraseIta 380, "America centrale"
    sPhraseFra 380, "Amérique centrale"
    sPhraseGer 380, "Mittelamerika"
    sPhraseSpa 380, "Centroamérica"
    sPhraseSwe 380, "Centralamerika"
    sPhraseNor 380, "Sentral-Amerika"
    sPhraseDan 380, "Central Amerika"

    'REM:
    sPhraseEng 381, "Venezuela"
    sPhraseIta 381, "Venezuela"
    sPhraseFra 381, "Vénézuéla"
    sPhraseGer 381, "Venezuela"
    sPhraseSpa 381, "Venezuela"
    sPhraseSwe 381, "Venezuela"
    sPhraseNor 381, "Venezuela"
    sPhraseDan 381, "Venezuela"
    ...
    'REM:
    sPhraseEng 388, "Northern Europe"
    sPhraseIta 388, "Europa settentrionale"
    sPhraseFra 388, "Europe du nord"
    sPhraseGer 388, "Nördliches Europa"
    sPhraseSpa 388, "Europa norteña"
    sPhraseSwe 388, "Nordeuropa"
    sPhraseNor 388, "Nord-Europa"
    sPhraseDan 388, "Nordeuropa"

    'REM:
    sPhraseEng 389, "Western Europe"
    sPhraseIta 389, "Europa occidentale"
    sPhraseFra 389, "Europe de l'ouest"
    sPhraseGer 389, "Westeuropa"
    sPhraseSpa 389, "Europa occidental"
    sPhraseSwe 389, "Västeuropa"
    sPhraseNor 389, "Vest-Europa"
    sPhraseDan 389, "Vesteuropa"

    'REM:
    sPhraseEng 390, "Southern Europe"
    sPhraseIta 390, "Europa Meridionale"
    sPhraseFra 390, "Europe du sud"
    sPhraseGer 390, "Südliches Europa"
    sPhraseSpa 390, "Europa del sur"
    sPhraseSwe 390, "Sydeuropa"
    sPhraseNor 390, "Sør-Europa"
    sPhraseDan 390, "Sydeuropa"

    'REM:
    sPhraseEng 391, "Ukraine"
    sPhraseIta 391, "Ucraina"
    sPhraseFra 391, "Ukraine"
    sPhraseGer 391, "Ukraine"
    sPhraseSpa 391, "Ucrania"
    sPhraseSwe 391, "Ukraina"
    sPhraseNor 391, "Ukraina"
    sPhraseDan 391, "Ukraine"

    'REM:
    sPhraseEng 392, "North Africa"
    sPhraseIta 392, "Africa settentrionale"
    sPhraseFra 392, "Afrique du nord"
    sPhraseGer 392, "Nördliches Afrika"
    sPhraseSpa 392, "Africa norteña"
    sPhraseSwe 392, "Nordafrika"
    sPhraseNor 392, "Nord-Afrika"
    sPhraseDan 392, "Nordafrika"
    ...
    'REM:
    sPhraseEng 394, "East Africa"
    sPhraseIta 394, "Africa est"
    sPhraseFra 394, "Afrique de l'est"
    sPhraseGer 394, "Ost Afrika"
    sPhraseSpa 394, "Africa oriental"
    sPhraseSwe 394, "Östafrika"
    sPhraseNor 394, "Øst-Afrika"
    sPhraseDan 394, "Østafrika"
    ...
    'REM:
    sPhraseEng 398, "Middle East"
    sPhraseIta 398, "Medio Oriente"
    sPhraseFra 398, "Moyen-Orient"
    sPhraseGer 398, "Mittler Nach Osten"
    sPhraseSpa 398, "Medio Del este"
    sPhraseSwe 398, "Mellanöstern"
    sPhraseNor 398, "Midt-Østen"
    sPhraseDan 398, "Middeløsten"
...
Private Sub initialisePhrases400()
    ...
    'REM:
    sPhraseEng 405, "Mongolia"
    sPhraseIta 405, "Mongolia"
    sPhraseFra 405, "Mongolie"
    sPhraseGer 405, "Mongolei"
    sPhraseSpa 405, "Mongolia"
    sPhraseSwe 405, "Mongoliet"
    sPhraseNor 405, "Mongolia"
    sPhraseDan 405, "Mongoliet"

    'REM:
    sPhraseEng 406, "Irkutsk"
    sPhraseIta 406, "Irkutsk"
    sPhraseFra 406, "Irkutsk"
    sPhraseGer 406, "Irkutsk"
    sPhraseSpa 406, "Irkutsk"
    sPhraseSwe 406, "Irkutsk"
    sPhraseNor 406, "Irkutsk"
    sPhraseDan 406, "Irkutsk"

    'REM:
    sPhraseEng 407, "Yakutsk"
    sPhraseIta 407, "Yakutsk"
    sPhraseFra 407, "Yakutsk"
    sPhraseGer 407, "Yakutsk"
    sPhraseSpa 407, "Yakutsk"
    sPhraseSwe 407, "Yakutsk"
    sPhraseNor 407, "Yakutsk"
    sPhraseDan 407, "Yakutsk"
    ...
    sPhraseIta 413, "Australia orientale"
    sPhraseFra 413, "Australie de l'est"
    sPhraseGer 413, "Ost Australien"
    sPhraseSpa 413, "Australia oriental"
    sPhraseSwe 413, "Östaustralien"
    sPhraseNor 413, "Øst-Australia"
    sPhraseDan 413, "Østlige Australien"
